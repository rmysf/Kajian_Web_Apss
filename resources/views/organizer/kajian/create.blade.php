<x-organizer-layout>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sm:p-8">
        <form action="{{ route('organizer.kajian.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title" class="w-full rounded-md border-gray-200 shadow-sm focus:border-brand-emerald-900 focus:ring focus:ring-brand-emerald-900 focus:ring-opacity-50" required placeholder="Contoh: Fiqih Muamalah Kontemporer" value="{{ old('title') }}">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select name="speaker_id" id="speaker_id" class="w-full rounded-md border-gray-200 shadow-sm focus:border-brand-emerald-900 focus:ring focus:ring-brand-emerald-900 focus:ring-opacity-50 text-gray-600" required>
                                    <option value="" disabled selected>Contoh: Ustadz Fulan</option>
                ...
                <div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal" id="tanggal" class="w-full rounded-md border-gray-200 shadow-sm focus:border-brand-emerald-900 focus:ring focus:ring-brand-emerald-900 focus:ring-opacity-50 text-gray-600" required value="{{ old('tanggal') }}">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="start_time" id="start_time" class="w-full rounded-md border-gray-200 shadow-sm focus:border-brand-emerald-900 focus:ring focus:ring-brand-emerald-900 focus:ring-opacity-50 text-gray-600 bg-white" required value="{{ old('start_time', '00:00') }}">
                            ...
                            <div>
                                ...
                                <input type="text" name="end_time" id="end_time" class="w-full rounded-md border-gray-200 shadow-sm focus:border-brand-emerald-900 focus:ring focus:ring-brand-emerald-900 focus:ring-opacity-50 text-gray-600 bg-white" required value="{{ old('end_time', '00:00') }}">
                        ...
                        <div>
                            ...
                            <textarea name="address" id="address" rows="3" class="w-full rounded-md border-gray-200 shadow-sm focus:border-brand-emerald-900 focus:ring focus:ring-brand-emerald-900 focus:ring-opacity-50 resize-none overflow-y-auto" required placeholder="Alamat lengkap menuju lokasi...">{{ old('address') }}</textarea>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-5">
                    ...
                    <div class="md:pl-12">
                        ...
                        <div class="h-[42px] flex items-center space-x-6">
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" name="is_family_friendly" value="1" class="text-brand-emerald-900 border-gray-300 focus:ring-brand-emerald-900 w-4 h-4" {{ old('is_family_friendly', '1') == '1' ? 'checked' : '' }}>
                                <span class="ml-2 text-sm text-gray-700">Ya</span>
                            </label>
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" name="is_family_friendly" value="0" class="text-brand-emerald-900 border-gray-300 focus:ring-brand-emerald-900 w-4 h-4" {{ old('is_family_friendly') == '0' ? 'checked' : '' }}>
                    ...
                    <div class="md:pl-12">
                        ...
                        <div class="h-[42px] flex items-center space-x-6">
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" name="is_free" value="1" id="radio_free" class="text-brand-emerald-900 border-gray-300 focus:ring-brand-emerald-900 w-4 h-4" {{ old('is_free', '1') == '1' ? 'checked' : '' }}>
                                <span class="ml-2 text-sm text-gray-700">Gratis</span>
                            </label>
                            <label class="inline-flex items-center cursor-pointer">
                                <input type="radio" name="is_free" value="0" id="radio_paid" class="text-brand-emerald-900 border-gray-300 focus:ring-brand-emerald-900 w-4 h-4" {{ old('is_free') == '0' ? 'checked' : '' }}>
